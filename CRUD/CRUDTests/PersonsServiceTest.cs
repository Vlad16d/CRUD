...
namespace CRUDTests
{
    public class PersonsServiceTest
    {
        ...
        public void DeletePerson_ValidPersonID()
        {
            ...
            PersonAddRequest person_add_request = new PersonAddRequest() { PersonName = "Jones", Address = "address", CountryID = country_response_from_add.CountryID, DateOfBirth = Convert.ToDateTime("2010-01-03"), Email = "jones@example.com", Gender = GenderOptions.Male, ReceiveNewsLetters = true };
